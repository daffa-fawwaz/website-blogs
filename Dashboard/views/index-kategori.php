                            ...
                            <div id="container">
                                <table class="w-full whitespace-no-wrap">
                                    ...
                                    <tbody
                                        ...
                                        <?php foreach ($category_paginate as $kategory): ?>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">
                                                    <?= $no ?>
                                                </td>
                                                <td class="px-4 py-3 text-sm">
                                                    <?= $kategory["name_category"] ?>
                                                </td>
                                                <td class="px-4 py-3 text-sm">
                                                    <?= count($category->count_cat($kategory["name_category"])); ?>
                                                </td>
                                                ...
                                                <?php else: ?>
                                                    <td class="px-4 py-3">
                                                        <div class="flex items-center space-x-4 text-sm">
                                                            <a href="update-kategori.php?id=<?= $kategory["id_category"] ?>">
                                                                <button
                                                            ...
                                                            <button onclick="confirmDelete(event, '<?= $kategory['id_category'] ?>')"
                                                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                                aria-label="Delete">
                                                                <svg
                                                                    class="w-5 h-5"
        ...
        function confirmDelete(event, id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        window.location.href = `../services/delete-kategori.php?id=${id}`;
                    }, 1200)
                } else if (
